 ...
 * use the methods provided by PopupCalendar to modify the
 * look and feel of the swing components.
...
public abstract class DateChooserStyle {
   ...
   * allows overriding of the default style with the various style adapter classes.
   * @param component
   * @param style
   */
